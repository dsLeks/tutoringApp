                            ...
                            <div className="row">
                                <div className="col-md-6 col-lg-3">
                                    <div className="img-block mb-5">
                                        ...
                                        <img id="imagesize"
                                            src={Picture}
                                            className="img-fluid  img-thumbnail rounded-circle border-dark" >< /img></a>
                                        <div className="content mt-2">
                                            <a id= "fontColor" className= "nav-item nav-links" href="/about/Justin-Diones">Justin Diones</a>
                                ...
                                <div className="col-md-6 col-lg-3 ">
                                    <div className="img-block mb-5">
                                        ...
                                        <img id="imagesize"
                                            src={Rui}
                                             className="img-fluid img-thumbnail rounded-circle border-warning" ></img> </a>
                                        <div className="content mt-2">
                                            <a id= "fontColor" className= "nav-item nav-links" href="/about/RuiQi-Huang">Rui Qi Huang</a>
                                ...
                                <div className="col-md-6 col-lg-3">
                                    <div className="img-block mb-5">
                                        ...
                                        <img id="imagesize"
                                            src={Rupak}
                                             className="img-fluid  img-thumbnail rounded-circle border-danger" ></img> </a>
                                        <div className="content mt-2">
                                            <a id= "fontColor" className= "nav-item nav-links" href="/about/Rupak-Khatri">Rupak Khatri</a>
                                            <p className="text-muted">Frontend Developer</p>
                                ...
                                <div className="col-md-6 col-lg-3">
                                    <div className="img-block mb-5">
                                        ...
                                        <img id="imagesize"
                                            src={Alex}
                                             className="img-fluid  img-thumbnail rounded-circle border-success" ></img> </a>
                                        <div className="content mt-2">
                                            <a id= "fontColor" className= "nav-item nav-links" href="/about/Alekhya-Gandu">Alekhya Gandu</a>
                                ...
                                <div className="col-md-6 col-lg-3">
                                    <div className="img-block mb-5">
                                        ...
                                        <img id="imagesize"
                                            src={Mai}
                                             className="img-fluid  img-thumbnail rounded-circle border-primary" ></img> </a>
                                        <div className="content mt-2">
                                            <a id= "fontColor" className= "nav-item nav-links" href="/about/Mai-Ra">Mai Ra</a>
                                    ...
                                    <div className="img-block mb-5">
                                        ...
                                        <img id="imagesize"
                                            src={William}
                                             className="img-fluid  img-thumbnail rounded-circle border-success" ></img> </a>
                                        <div className="content mt-2">
                                            <a  id= "fontColor" className= "nav-item nav-links" href="/about/William-Lushbough">William Lushbough</a>
